#priority based , first in first out 
# fornt does not do any movement only rear does the movement 

# full queue when rear = capcity -1 ( overflow)
# to delete it will delete from front and queue will shift forward 
# queue is empty when rear is -1 (underflow)
